...
CREATE or ALTER PROCEDURE [dbo].[sp_update_jobstep_for_non_admins]
(
	...
	@flags                  INT                 = NULL,
	@proxy_id               int                 = NULL,
	@proxy_name             sysname             = NULL	-- mutual exclusive; must specify only one of above 2 parameters to identify the proxy.
)
WITH EXECUTE AS OWNER
AS
BEGIN
	EXEC sp_update_jobstep
		@job_id , -- Must provide either this or job_name
		@job_name , -- Not updatable (provided for identification purposes only)
		@step_id , -- Not updatable (provided for identification purposes only)
		@step_name ,
		@subsystem ,
		@command ,
